...
- In `../index.md`, update "Design Risks and Issues" section item 3 to note that lifecycle transition enforcement is now delivered.
...
- Add a reference to `../agent-safe-planning-core/spec.md` in the Links section.
