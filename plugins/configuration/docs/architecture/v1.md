...
- governed template, profile, and receipt truth lives under `plugins/configuration/`
- `plugins/configuration` owns reusable `list`, `show`, `apply`, and
...
- deterministic application and verification of governed configuration carried by local plugin packages
...
- schemas and fixtures under `plugins/configuration/schemas/` and `plugins/configuration/fixtures/`
