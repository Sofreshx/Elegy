...
# Historical monetization infrastructure proposal

> This is retained research, not current architecture or distribution policy.
> Its assumption that Client Radar and AI Radar should be Elegy plugins was
> rejected by the evidence-backed readiness and system-adapter boundary ADR.
> The named wrappers were removed from Elegy distribution. Do not use the
> packaging, marketplace, or product claims below as implementation guidance.
