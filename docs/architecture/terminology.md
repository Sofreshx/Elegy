...
In Elegy, authority surfaces are the governed artifact roots under `contracts/`, `schemas/`, and `policies/`. Rust implements operational behavior that consumes those artifacts but does not replace their canonical truth.
