...
This directory contains the current high-level architectural guidance for the main Elegy monorepo.

## Core references

- [Ecosystem topology](ecosystem-topology.md) - repo and package-family organization
