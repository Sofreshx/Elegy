...
- [elegy-planning graph core spec](../../plugins/planning/docs/specs/graph-core.md)
- [elegy-planning deterministic state machine spec](../../plugins/planning/docs/specs/state-machine.md)
- [elegy-planning acceptance and evidence spec](../../plugins/planning/docs/specs/acceptance-evidence.md)
- [elegy-planning run trace and context spec](../../plugins/planning/docs/specs/run-trace-context.md)
- [elegy-planning v1 spec](../../plugins/planning/docs/specs/index.md)
