...
Portable plugin package contracts, such as `elegy-plugin-package/v1`, also live
here. They describe bundle metadata and component references for consuming
hosts; they do not create an Elegy-hosted plugin runtime.
