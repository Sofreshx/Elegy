---
name: elegy-mermaid
description: "Derived repo-local skill bridge mirror for Elegy's Mermaid tooling surface. Use for canonical Mermaid render, bounded Mermaid reverse projection, and concise Mermaid/canonical narrative output through the umbrella elegy CLI."
---
...
1. `contracts/fixtures/skill-definition-v2.elegy-mermaid.json` is the governed source of truth.
...
3. `.agents/skills/elegy-mermaid/SKILL.md` and `.github/skills/elegy-mermaid/SKILL.md` are repo-local rendered mirrors only.
