...
- **Deferred:** `diff`, `review`, `validate` commands — see `docs/specs/codegraph-diff-slice.md`.

## Deferred command stubs

The following subcommands are deferred to a follow-up spec (`docs/specs/codegraph-diff-slice.md`):
