...
`rust/features/elegy-planning` is the implementation center. `rust/bin/elegy-cli`
...
7. This document (`rust/features/elegy-planning/docs/architecture/v1.md`) is the
...
The implemented CLI surface in `rust/features/elegy-planning/src/cli.rs` is:
