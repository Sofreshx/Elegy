...
const GOVERNED_RECORD_FIXTURE_JSON: &str =
    include_str!("../../../../contracts/fixtures/governed-memory-record.minimal.json");
const GOVERNED_PROJECTION_FIXTURE_JSON: &str =
    include_str!("../../../../contracts/fixtures/governed-memory-record-projection.minimal.json");
