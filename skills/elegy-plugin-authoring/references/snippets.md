...
```json
{
  ...
  "kind": "skill-package",
  "packaging": "plugin",
  "pluginRoot": "skills/elegy-example",
  "skillRoot": "skills/elegy-example",
  "description": "Specific task and audience."
}
```
...
```json
{
  "name": "elegy-example",
  "kind": "bundled-plugin",
  "package": "elegy-example",
  "crateRoot": "plugins/example",
  "packaging": "plugin",
...
```text
marketplace-wrappers/<plugin-name>/
  .elegy-plugin/plugin.json
  README.md
```
...
```json
{
  ...
  "packaging": "plugin",
  "pluginRoot": "marketplace-wrappers/example",
