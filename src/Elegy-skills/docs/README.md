...
- `docs/architecture/mcp-skill-tooling-placement.md` for lower-level MCP-to-skill generation placement outside the main registry surface.
- `docs/architecture/ecosystem-topology.md` for repo-center guidance.
- `contracts/`, `governance/`, and `rust/` for canonical ownership; treat `.github/skills/` as repo-local non-authoritative contributor-routing output only.
